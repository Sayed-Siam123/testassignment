...
class SecondTask extends StatelessWidget {
  ...
  AutoScrollController _controller = new AutoScrollController();
    ...
    return BaseWidget(
      builder: (context, sizingInformation) {
        ...
        return GetBuilder<HomeController>(
          initState: (_){
            homeController.fetchTokenFreeListDataWithPagination(skip: 0,limit: 4);
              ...
              body: Builder(
                builder: (context) {
                  ...
                  return Container(
                    ...
                    child: Text("${homeController.get_tfl_list2.getPackages.result.count.toString()} Available Holidays",style: lgFontStyleBold.copyWith(fontSize: fSize(fontSize: large,mediaQueryWidth: sizingInformation.localWidgetSize.width))),
                  ),
                  Expanded(
                  child: Container(
                  width: sizingInformation.localWidgetSize.width,
                  child: ListView.builder(
                    controller: _controller,
                            ...
                            shrinkWrap: true,
                            itemCount: homeController.get_tfl_list2.getPackages.result.packages.length,
                                                  ...
                                                  Expanded(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: CachedNetworkImage(
                                                        imageUrl: homeController.get_tfl_list2.getPackages.result.packages[index].thumbnail,
                                                          ...
                                                          children: [
                                                            Expanded(
                                                              child: Column(
                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                                children: [
                                                                  Text("${homeController.get_tfl_list2.getPackages.result.packages[index].title}",style: lgFontStyleBold.copyWith(fontSize: fSize(fontSize: large,mediaQueryWidth: sizingInformation.localWidgetSize.width), height: 1.5),),
                                                                  SizedBox(height: sizingInformation.localWidgetSize.height*0.007,),
                                                                  Expanded(
                                                                    child: Text("${homeController.get_tfl_list2.getPackages.result.packages[index].description}",
                                                              ...
                                                              children: [
                                                                Row(
                                                                  children: [
                                                                    ...
                                                                    Text("${homeController.get_tfl_list2.getPackages.result.packages[index].durationText}",style: mdfontStyleMedium.copyWith(fontSize: fSize(fontSize: regular,mediaQueryWidth: sizingInformation.localWidgetSize.width)),),
                                                                  ],
                                                                ),
                                                              ],
                                                            )
                                                            ...
                                                            children: [
                                                              Container(
                                                                ...
                                                                child: ListView.builder(
                                                                  ...
                                                                  itemCount: homeController.get_tfl_list2.getPackages.result.packages[index].amenities.length,
                                                                  itemBuilder: (context, index1) {
                                                                    return Row(
                                                                      children: [
                                                                        SvgPicture.network("${homeController.get_tfl_list2.getPackages.result.packages[index].amenities[index1].icon}",
                                                              ...
                                                              Text("৳ ${NumberFormat.decimalPattern().format(homeController.get_tfl_list2.getPackages.result.packages[index].startingPrice)}",style: lgFontStyleBold.copyWith(color: white,fontSize: fSize(fontSize: large,mediaQueryWidth: sizingInformation.localWidgetSize.width)),),
                                                            ],
                                                          ),
                                                        ),
